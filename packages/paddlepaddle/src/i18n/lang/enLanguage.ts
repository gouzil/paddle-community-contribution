export default {
  ...
  footer: {
    ...
    privacyLink: 'https://www.paddlepaddle.org.cn/', // 没有隐私政策页面
    legal: 'Legal Notice',
    legalLink: 'https://www.paddlepaddle.org.cn/', // 没有法律声明
    copyright: 'Copyright © 2023 PaddlePaddle. All rights reserved.',
  },
  about: {
